...
# Posted by timhc22, modified by community. See post 'Timeline' for change history
...
#get number parts
VNUM1=`echo ${CURRENT_VERSION_PARTS[0]} | sed -e 's/[^0-9]//g'`
...
if [ -z "$NEEDS_TAG" ]; then
    git tag $NEW_TAG -m "Version $VNUM1.$VNUM2.$VNUM3"
